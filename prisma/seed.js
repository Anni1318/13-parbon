...
async function main() {
  ...
  const pandalData = [
    ...
    // Central Kolkata
    { id: 'p-college-sq', name: 'College Square', slug: 'college-square', zone: 'Central Kolkata', area: 'College Street', address: 'College Square, College Street, Kolkata', pincode: '700073', latitude: 22.5760, longitude: 88.3639, isFeatured: true, sourceName: 'anandabazar.com' },
    { id: 'p-mohd-ali', name: 'Mohammad Ali Park', slug: 'mohammad-ali-park', zone: 'Central Kolkata', area: 'Central Kolkata', address: 'Mohammad Ali Park, Kolkata', pincode: '700016', latitude: 22.5778, longitude: 88.3596, isFeatured: true, sourceName: 'anandabazar.com' },
    { id: 'p-santosh-mitra', name: 'Santosh Mitra Square', slug: 'santosh-mitra-square', zone: 'Central Kolkata', area: 'Lebutala', address: 'Lebutala, Bowbazar, Kolkata', pincode: '700012', latitude: 22.5681, longitude: 88.3531, isFeatured: true, sourceName: 'anandabazar.com' },
    // South Kolkata
    ...
    { id: 'p-fd-block', name: 'FD Block Durga Puja', slug: 'fd-block-salt-lake', zone: 'Salt Lake', area: 'Salt Lake', address: 'FD Block, Sector III, Salt Lake City, Kolkata', pincode: '700106', latitude: 22.5772, longitude: 88.4118, isFeatured: false, sourceName: 'kolkatapuja.com' },
    { id: 'p-ae-block', name: 'AE Block Salt Lake', slug: 'ae-block-salt-lake', zone: 'Salt Lake', area: 'Salt Lake', address: 'AE Block, Sector I, Salt Lake City, Kolkata', pincode: '700064', latitude: 22.5731, longitude: 88.4153, isFeatured: false, sourceName: 'kolkatapuja.com' },
    { id: 'p-bosepukur', name: 'Bosepukur Sitala Mandir', slug: 'bosepukur-sitala-mandir', zone: 'East Kolkata', area: 'Kasba', address: 'Bosepukur Road, Kasba, Kolkata', pincode: '700042', latitude: 22.5056, longitude: 88.3954, isFeatured: false, sourceName: 'kolkatapuja.com' },
    { id: 'p-kasba-talbagan', name: 'Kasba Bosepukur Talbagan', slug: 'kasba-bosepukur-talbagan', zone: 'East Kolkata', area: 'Kasba', address: 'Talbagan, Kasba, Kolkata', pincode: '700042', latitude: 22.5028, longitude: 88.3938, isFeatured: true, sourceName: 'anandabazar.com' },
  ];
